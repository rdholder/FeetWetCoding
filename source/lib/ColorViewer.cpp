...
int ColorViewer::DrawCircle( int x, int y, int r, Color color, int thickness, bool solid )
{
...
int ColorViewer::DrawText( std::string text, int x, int y, Color color, int size )
{
    FeetWetCodingExercise::RenderItem item;
